...
bsn_url <- setNames(as.list(bsn_url$url), bsn_url$BusinessShortNumber)
...
bsn_url <- toJSON(bsn_url, pretty = TRUE, auto_unbox = TRUE)
...
write(bsn_url, here("vue", "antd-demo", "src", "bsn_url.json"))
