...
# Load Topics
topics <- read.csv(here("scripts", "07_BERTopic", "v230820", "BERT_data", "topic_info.csv"), header = T)
...
topic_probs <- read.csv(here("scripts", "07_BERTopic", "v230820", "BERT_data", "probs.csv"), header = F)
