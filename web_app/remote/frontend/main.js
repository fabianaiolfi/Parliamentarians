...
fetch('http://104.248.19.10/api/persons') // was fetch('http://127.0.0.1:5000/api/persons')
...
document.getElementById('person-dropdown').addEventListener('change', function() {
    ...
    fetch(`http://104.248.19.10/api/business_items/${personNumber}`) // was  fetch(`http://127.0.0.1:5000/api/business_items/${personNumber}`)
        .then(response => response.json())
